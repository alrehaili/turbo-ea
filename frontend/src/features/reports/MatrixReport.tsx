...
export default function MatrixReport() {
  ...
  //
  // An explicit ``?row_type=&col_type=`` deep-link (used by NEA View-Library
  // preset viewpoints, e.g. "Applications by Org Unit") takes precedence over
  // stale localStorage so the preset renders the intended axes.
