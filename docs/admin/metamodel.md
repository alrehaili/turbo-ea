...
Navigate to **Admin > Metamodel** to access the metamodel editor. It has nine tabs: **Card Types**, **Relation Types**, **Calculations**, **Tags**, **Metamodel Graph**, **EA Principles**, **Standards**, **Compliance Regulations**, and **Resources**.
