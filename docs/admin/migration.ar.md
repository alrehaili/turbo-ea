...
| **قوالب حصر البيانات — البنية المؤسسية الوطنية (NORA)** | مصنف xlsx لحصر البيانات — مصنف لكل مجال من مجالات البنية (الأعمال / التطبيقات / التقنية / الأمن / البيانات) |
...
### قوالب حصر البيانات (هيئة الحكومة الرقمية)

يستوعب المستورد أيضاً مصنفات حصر البيانات الرسمية لإطار عمل البنية المؤسسية الوطنية — مصنف لكل مجال من مجالات البنية (الأعمال، التطبيقات، التقنية، الأمن، البيانات). تُنشأ البطاقات على الأنواع المطابقة: الخدمات، إجراءات الأعمال، التطبيقات، نقاط الربط التقني، كيانات البيانات، ومكونات التقنية والأمن كأنواع فرعية لمكوّن تقنية المعلومات. وتُترجم أعمدة الخيارات من قوائم القوالب نفسها إلى حقول ملف نورا التعريفي، لذا يجب تفعيل ملف نورا قبل الاستيراد.

تتحول الإشارات بالأسماء بين الصفوف (الخدمات ← التطبيقات، الإجراءات ← الخدمات، نقاط الربط ← التطبيقات المستهلكة والمنتجة، الخدمة الفرعية ← الخدمة الأساسية) إلى علاقات وروابط هرمية. وأي اسم مُشار إليه دون صف خاص به يُنشأ كبطاقة مبدئية — أو يُربط ببطاقة موجودة بالاسم نفسه — بحيث تُنشأ العلاقات دائماً وتبقى فجوات الحصر ظاهرة. يمكن رفع المصنفات بأي ترتيب وإعادة استيرادها بأمان.

لا يتم بعد استيراد: ورقة تحسينات رحلات المستفيدين، وأوراق النماذج والسياسات وأصحاب المصلحة في مصنف الأعمال، وسجلات مستوى السمات (فهرس الأعمال / سمات البيانات) في مصنف البيانات.
