...
TYPES = [
    ...
    },
    {
        "key": "DataDomain",
        "label": "Data Domain",
        "description": "A governed grouping of related data objects with a steward and policies.",
        "icon": "hub",
        "color": "#5e35b1",
        "category": "Data",
        "has_hierarchy": True,
        ...
        "fields_schema": [
            {
                ...
                "translations": {
                    "de": "Domäneninformationen",
                    "fr": "Informations sur le domaine",
                    "es": "Información del dominio",
                    "it": "Informazioni sul dominio",
                    "pt": "Informações do domínio",
                    "zh": "域信息",
                    "ru": "Информация о домене",
                    "da": "Domæneoplysninger",
                    "ar": "معلومات النطاق",
                },
                "fields": [
                    {
                        ...
                        "translations": {
                            ...
                            "fr": "Intendant des données",
                            "es": "Custodio de datos",
                            "it": "Responsabile dei dati",
                            "pt": "Curador de dados",
                            "zh": "数据管理员",
                            "ru": "Ответственный за данные",
                            "da": "Dataforvalter",
                            "ar": "مسؤول البيانات",
                        },
                    },
                    ...
                    },
                    {
                        ...
                        "translations": {
                            ...
                            "es": "Política de retención",
                            "it": "Politica di conservazione",
                            "pt": "Política de retenção",
                            "zh": "保留策略",
                            "ru": "Политика хранения",
                            "da": "Opbevaringspolitik",
                            "ar": "سياسة الاحتفاظ",
                        },
                    },
                    {
        ...
        "translations": {
            ...
            "description": {
                "de": "Eine geführte Gruppierung zusammengehöriger Datenobjekte mit Verantwortlichem und Richtlinien.",
                "fr": "Un regroupement gouverné d'objets de données liés, avec un intendant et des politiques.",
                "es": "Una agrupación gobernada de objetos de datos relacionados con un custodio y políticas.",
                "it": "Un raggruppamento governato di oggetti dati correlati con un responsabile e politiche.",
                "pt": "Um agrupamento governado de objetos de dados relacionados com um curador e políticas.",
                "zh": "一组受治理的相关数据对象，具有管理员和策略。",
                "ru": "Управляемая группа связанных объектов данных с ответственным и политиками.",
                "da": "En styret gruppering af relaterede dataobjekter med en forvalter og politikker.",
                "ar": "تجميع محكوم لكائنات بيانات مرتبطة مع مسؤول وسياسات.",
            },
        },
    },
    {
        "key": "DataProduct",
        "label": "Data Product",
        "description": "A consumable, owned data product exposing data objects with an SLA.",
        "icon": "inventory_2",
        "color": "#8e24aa",
        "category": "Data",
        "has_hierarchy": False,
                ...
                "fields": [
                    {
                        ...
                        "weight": 1,
                        "translations": {
                            "de": "Produktverantwortlicher",
                            "fr": "Responsable de produit",
                            "es": "Propietario del producto",
                            "it": "Responsabile del prodotto",
                            "pt": "Responsável pelo produto",
                            "zh": "产品负责人",
                    ...
                    },
                    {
                        ...
                        "label": "Maturity",
                        "type": "single_select",
                        "options": DATA_PRODUCT_MATURITY_OPTIONS,
                        "weight": 1,
                        "translations": {
                            "de": "Reifegrad",
                            "fr": "Maturité",
        ...
        "translations": {
            ...
            "description": {
                "de": "Ein konsumierbares, verantwortetes Datenprodukt, das Datenobjekte mit einem SLA bereitstellt.",
                "fr": "Un produit de données consommable et responsabilisé exposant des objets de données avec un SLA.",
                "es": "Un producto de datos consumible y con propietario que expone objetos de datos con un SLA.",
                "it": "Un prodotto dati consumabile e con responsabile che espone oggetti dati con uno SLA.",
                "pt": "Um produto de dados consumível e com responsável que expõe objetos de dados com um SLA.",
                "zh": "一个可消费、有归属的数据产品，通过 SLA 暴露数据对象。",
                "ru": "Потребляемый управляемый продукт данных, предоставляющий объекты данных с SLA.",
                "da": "Et forbrugbart, ejet dataprodukt, der eksponerer dataobjekter med en SLA.",
                "ar": "منتج بيانات قابل للاستهلاك ومملوك يعرض كائنات البيانات وفق اتفاقية مستوى خدمة.",
            },
        },
    },
    # -- Technology layer --
...
RELATIONS = [
    ...
    {
        "key": "relDataObjToDataDomain",
        "label": "belongs to domain",
        "reverse_label": "contains",
        "source_type_key": "DataObject",
        "target_type_key": "DataDomain",
        "cardinality": "n:1",
        "sort_order": 21,
        "attributes_schema": [],
        "translations": {
            "label": {
                "de": "gehört zur Domäne",
                "fr": "appartient au domaine",
                "es": "pertenece al dominio",
                "it": "appartiene al dominio",
                "pt": "pertence ao domínio",
                "zh": "属于域",
                "ru": "относится к домену",
                "da": "tilhører domæne",
                "ar": "ينتمي إلى النطاق",
            },
            "reverse_label": {
    ...
    {
        "key": "relDataProductToDataObj",
        "label": "exposes",
        "reverse_label": "is exposed by",
        "source_type_key": "DataProduct",
        "target_type_key": "DataObject",
        "cardinality": "n:m",
        "sort_order": 22,
        "attributes_schema": [],
