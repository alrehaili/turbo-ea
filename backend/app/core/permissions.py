...
APP_PERMISSIONS: dict[str, dict] = {
    ...
    "reports": {
        ...
        "permissions": {
            ...
            "reports.roadmap_manage": "Create and edit saved transformation roadmaps",
        },
    },
    "rationalization": {
        "label": "Application Rationalization",
        "permissions": {
            "rationalization.view": "View application rationalization campaigns",
            "rationalization.manage": "Create and manage rationalization campaigns",
        },
    },
    "tech_standards": {
        "label": "Technology Standards",
        "permissions": {
            "tech_standards.view": "View the technology standards catalogue and exceptions",
            "tech_standards.manage": "Create and manage technology standards and exceptions",
            "tech_standards.approve_exception": "Approve or reject standard exception requests",
        },
    },
    "arb": {
        "label": "Architecture Review Board",
        "permissions": {
            "arb.view": "View architecture review board reviews",
            "arb.manage": "Create and decide architecture review board reviews",
        },
    },
    "scenarios": {
        "label": "Scenario Planning",
        "permissions": {
            "scenarios.view": "View transition-architecture scenarios",
            "scenarios.manage": "Create and edit scenarios and their changes",
            "scenarios.merge": "Merge an approved scenario into the live repository",
        },
    },
    "surveys": {
        "label": "Surveys",
...
BPM_ADMIN_PERMISSIONS: dict[str, bool] = {
    ...
    "reports.roadmap_manage": True,
    "rationalization.view": True,
    "rationalization.manage": True,
    "tech_standards.view": True,
    "tech_standards.manage": True,
    "tech_standards.approve_exception": True,
    "arb.view": True,
    "arb.manage": True,
    "scenarios.view": True,
    "scenarios.manage": True,
    "scenarios.merge": True,
...
VIEWER_PERMISSIONS: dict[str, bool] = {
    ...
    "reports.ppm_dashboard": True,
    "reports.portfolio": True,
    "reports.roadmap_manage": False,
    "rationalization.view": True,
    "rationalization.manage": False,
    "tech_standards.view": True,
    "tech_standards.manage": False,
    "tech_standards.approve_exception": False,
    "arb.view": True,
    "arb.manage": False,
    "scenarios.view": True,
    "scenarios.manage": False,
